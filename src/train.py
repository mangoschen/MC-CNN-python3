...
parser.add_argument("--end_epoch", type=int, default=4000, help="end epoch for training(exclusive)")
...
parser.add_argument("--tensorboard_dir", type=str, default="../data/tensorboard", help="model validation frequency(of epoches)")
parser.add_argument("--checkpoint_dir", type=str, default="../data/checkpoint", help="")
parser.add_argument("--list_dir", type=str, default="../data/list", help=" the folder including train.txt and val.txt files")
